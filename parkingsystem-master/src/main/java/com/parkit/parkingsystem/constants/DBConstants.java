...
public class DBConstants {
    ...
    /**
     * 
     * Ajout d'une requête permettant de compter la récurrence d'un véhicule
     * @author melisabeth
     */
    
    public static final String GET_RECURRENT_USER ="SELECT COUNT(*) FROM prod.ticket WHERE VEHICLE_REG_NUMBER= ?";
}
